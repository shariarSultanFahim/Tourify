...
const Profile = () => {
    ...
    const {theme,user,currentPhoto} = useContext(AuthContext);
        ...
        <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className=" w-full shadow overflow-hidden sm:rounded-lg">
                <div className="px-4 py-5 sm:px-6">
                    <h3 className={`text-lg leading-6 font-medium ${theme==='light'?'text-gray-900':''}`}>
                        User Info
                    </h3>
                    <p className="mt-1 max-w-2xl text-sm ${theme==='light'?'text-gray-500':''}">
                ...
                <div className="border-t ">
                    <dl>
                        <div className=" px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt className={`text-sm font-medium ${theme==='light'?'text-gray-500':''}`}>
                                Full name
                            </dt>
                            <dd className={`mt-1 text-sm ${theme==='light'?'text-gray-900':''} sm:mt-0 sm:col-span-2`}>
                            {currentName}
                            </dd>
                        </div>
                        <div className=" px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
