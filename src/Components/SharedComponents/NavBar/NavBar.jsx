...
const NavBar = () => {
    ...
    const items = <>
    <NavLink to={"/"} className={({ isActive }) => isActive ? 'px-3 py-2 bg-green-700 border-[1px] rounded-xl text-white ' : 'btn-ghost  px-3 py-2 rounded-xl'}>Home</NavLink>
    <NavLink to='/allTouristSpots' className={({ isActive }) => isActive ? 'px-3 py-2 bg-green-700 border-[1px] rounded-xl text-white' : 'btn-ghost  px-3 py-2 rounded-xl'}>All Tourists Spot</NavLink>
    {
